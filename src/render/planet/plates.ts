...
export const MACRO: Record<PlanetVisualType, MacroParams> = {
  ...
  ocean:  { plateCount: 26, continents: 4, landCoverage: 0.30, sizeVariety: 0.35, uplift: 0.26, rangeWidth: 0.055, detailScale: 3.0, normalStrength: 0.20, coastAmp: 0.40, coastFreq: 2.4, rangeVar: 0.55, craters: 0.15, craterFreq: 10, craterDepth: 0.05 , canyons: 0.15, canyonFreq: 2.6, canyonDepth: 0.08 },
  ...
  lava:   { plateCount: 30, continents: 6, landCoverage: 0.68, sizeVariety: 0.45, uplift: 0.36, rangeWidth: 0.045, detailScale: 3.5, normalStrength: 0.26, coastAmp: 0.38, coastFreq: 2.6, rangeVar: 0.7, craters: 0.25, craterFreq: 9, craterDepth: 0.05 , canyons: 0.3, canyonFreq: 3.0, canyonDepth: 0.08 },
  ice:    { plateCount: 8, continents: 3, landCoverage: 0.5, sizeVariety: 0.3, uplift: 0.2, rangeWidth: 0.06, detailScale: 3.0, normalStrength: 0.2, coastAmp: 0.32, coastFreq: 2.2, rangeVar: 0.5, craters: 0, craterFreq: 8, craterDepth: 0.06 , canyons: 0.2, canyonFreq: 2.8, canyonDepth: 0.06 },
  gas:    { plateCount: 8, continents: 3, landCoverage: 0.5, sizeVariety: 0.3, uplift: 0.2, rangeWidth: 0.06, detailScale: 3.0, normalStrength: 0.2, coastAmp: 0, coastFreq: 2.2, rangeVar: 0, craters: 0, craterFreq: 8, craterDepth: 0.06 , canyons: 0, canyonFreq: 2.6, canyonDepth: 0 },
};
